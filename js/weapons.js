...
const WEAPON_CATEGORIES = [
  { name: 'SIDEARM',  icon: '🔫', weapons: ['classic', 'sheriff'] },
  { name: 'SMGs',     icon: '⚡', weapons: ['stinger', 'spectre'] },
  { name: 'RIFLES',   icon: '🎯', weapons: ['guardian', 'phantom', 'vandal'] },
  { name: 'SNIPER',   icon: '🔭', weapons: ['marshal', 'operator'] },
  { name: 'SHOTGUNS', icon: '💥', weapons: ['bucky', 'judge'] },
  { name: 'HEAVY',    icon: '🔥', weapons: ['ares', 'odin'] },
];
